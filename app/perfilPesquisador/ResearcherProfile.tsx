            ...
            >
                <div className="w-full max-w-md flex flex-col items-center">
                    ...
                    <form onSubmit={enviarArquivo} className="w-full max-w-sm">
                        ...
                        <motion.div
                            className={`w-full p-8 rounded-xl border-2 border-dashed min-h-[250px] ${isDragging ? "border-white bg-[#b30000]" : "border-[#ff9999]"
                        ...
                        <motion.button
                            type="submit"
                            className={`w-full py-3 px-6 rounded-lg font-medium text-[#990000] bg-white hover:bg-gray-100 transition-colors duration-300 flex items-center justify-center ${!arquivo ? "opacity-50 cursor-not-allowed" : "cursor-pointer"
                                }`}
