...
export function PremiacoesSection({ data, onAdd, onEdit, onDelete }: any) {
  ...
  return (
    <PerfilAcademicoSectionLayout title="Prêmios e Títulos">
      ...
      <div className="flex justify-center pt-2">
        ...
        >
          + Adicionar Prêmio ou Título
        </button>
      </div>

      {/* Empty State - Quando não há premiações */}
      {data.length === 0 && (
        <div className="flex flex-col items-center justify-center py-12 px-4 mt-4">
          <div className="bg-gray-50 border-2 border-dashed border-gray-300 rounded-lg p-8 max-w-md w-full text-center">
            ...
            <p className="text-gray-600 text-sm">
              Adicione seus prêmios e títulos para enriquecer seu perfil e destacar suas conquistas acadêmicas.
            </p>
          </div>
        </div>
      )}
