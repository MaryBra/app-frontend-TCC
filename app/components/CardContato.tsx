...
export function CardContato({
  ...
  const [localizacaoEdit, setLocalizacaoEdit] = useState(localizacao || "");
  ...
  const handleHabilitarContato = () => {
    router.push("/telaEdicaoPesquisador")
  };
          ...
          {podeEditar && !exibirContato && (
            <div className="text-center space-y-4">
              <p className="text-sm text-black">
                Você ainda não configurou suas informações de contato para exibição.
              </p>
              <button
                onClick={handleHabilitarContato}
          ...
          {podeEditar && exibirContato && (
            <div className="space-y-6">
              ...
              <Field icon={<MapPin size={20} />}>
                <p className="text-gray-900">{localizacao || "Não informado"}</p>
              </Field>
