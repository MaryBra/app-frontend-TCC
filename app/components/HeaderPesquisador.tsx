        ...
        <div className="flex-1 flex flex-col min-h-[300px]">
          ...
          <div className="mt-auto flex gap-3 pt-4 justify-center lg:justify-start">
            <button
              ...
              className="px-6 py-2 rounded shadow border border-white text-white bg-transparent hover:bg-white hover:text-[#990000] transition font-semibold dark:border-gray-300 dark:text-gray-300 dark:hover:bg-gray-300 dark:hover:text-[#990000]"
            >
              Contato
            </button>
            ...
            {podeEditar && (
              <Link
                ...
                className="border border-white text-white px-4 py-1 rounded hover:bg-white hover:text-[#990000] transition flex items-center justify-center font-semibold shadow dark:border-gray-300 dark:text-gray-300 dark:hover:bg-gray-300 dark:hover:text-[#990000]"
              >
                Gerenciar Listas
              </Link>
            )}
